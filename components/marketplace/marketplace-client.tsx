...
const copy = {
  ar: {
    ...
    choosePortalHint: 'اختر المسار المناسب لإدارة العرض أو الطلب.',
  ...
  en: {
    ...
    choosePortalHint: 'Select the appropriate workflow to manage a supply listing or purchase request.',
